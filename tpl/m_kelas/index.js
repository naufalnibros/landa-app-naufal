app.controller('kelasCtrl', function($scope, Data, toaster,$uibModal) {
    var tableStateRef;
    var control_link = "m_kelas";
    $scope.formTitle = '';
    $scope.displayed = [];
    $scope.form = {};
    $scope.is_edit = false;
    ...
    Data.get(control_link + '/cabang').then(function(result){
      $scope.cabang = result.data.data;
    });
